        ...
        <div className="movie-list-container">
            ...
            <div className="movie-list-wrapper">
                <div className="movie-list">
                    ...
                    <div className="movie-list-item">
                        <img className="movie-list-item-img" src={IMG4} alt="robin-hood"/>
                    ...
                    <div className="movie-list-item">
                        <img className="movie-list-item-img" src={IMG6} alt="un-buen-dia-para-morir"/>
                        <span className="movie-list-item-title">Un Buen Dia para Morir</span>
                        <p className="movie-list-item-desc">
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusamus mollitia 
                            alias obcaecati magni delectus minima quisquam asperiores
                        </p>
